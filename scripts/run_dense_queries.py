...
def main() -> None:
    queries = [
        ("movies about memory and identity", {"dense_top_k": 5}, None),
        ("movies starring Sigourney Weaver", {"dense_top_k": 5}, None),
        (
    ...
    for query, params, filters in queries:
        print("===", query, "===")
        results = retrieve(query=query, strategy="dense_only", params=params, filters=filters)
